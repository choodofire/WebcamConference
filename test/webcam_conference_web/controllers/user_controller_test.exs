defmodule WebcamConferenceWeb.UserControllerTest do
  use WebcamConferenceWeb.ConnCase

  import WebcamConference.UsersFixtures

  @create_attrs %{name: "some name", description: "some description", gender: true}
