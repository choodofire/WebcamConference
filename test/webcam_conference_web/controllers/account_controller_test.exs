defmodule WebcamConferenceWeb.AccountControllerTest do
  use WebcamConferenceWeb.ConnCase

  import WebcamConference.AccountsFixtures

  @create_attrs %{email: "some email", hash_password: "some hash_password"}
